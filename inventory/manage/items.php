	...
	if ($input_error != 1)
	{
		...
		{ /*so its an existing one */
			update_item($_POST['NewStockID'], $_POST['description'],
				$_POST['long_description'],$_POST['types'],$_POST['to_date'],$_POST['from_date'],$_POST['warranty'], $_POST['category_id'], $_POST['sub_cat_name'], $_POST['weight'], 
		...
		{ //it is a NEW part
			...
			add_item($_POST['NewStockID'], $_POST['description'],
				$_POST['long_description'],$_POST['types'],$_POST['to_date'],$_POST['from_date'],$_POST['warranty'], $_POST['category_id'],$_POST['sub_cat_name'],$_POST['weight'], $_POST['tax_type_id'],
...
if($_POST['types']==1){
	date_row(_("From Date") . ":", 'to_date',20);
date_row(_("To Date") . ":", 'from_date',20);
text_row(_("Warranty:"), 'warranty', null, 20, 200);
}
...
stock_categories_list_row(_("Category:"), 'category_id', null, false, true);
	...
	sub_category_list_row(_("Sub Category:"), 'sub_cat_name', null, false, true, $category_id);
            $getcode =get_sub_code($_POST['sub_cat_name']);
	label_row(_("Code:"), $getcode['code']);
	
	weight_row(_("Weight (in kgs.):"), 'weight', 0, null, null, 2);
