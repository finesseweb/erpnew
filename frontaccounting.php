...
if (!isset($path_to_root) || isset($_GET['path_to_root']) || isset($_POST['path_to_root']))
	...
	include_once($path_to_root . '/applications/inventory.php');
        include_once($path_to_root . '/applications/transport.php');
	include_once($path_to_root . '/applications/fixed_assets.php');
	include_once($path_to_root . '/applications/manufacturing.php');
	include_once($path_to_root . '/applications/LMS.php');
        include_once($path_to_root . '/applications/transportation.php');
	...
	class front_accounting
	{
		...
		function init()
		{
            ...
            $this->add_application(new transportation_app());
			$this->add_application(new maintenance_app());
            $this->add_application(new transport_app());
