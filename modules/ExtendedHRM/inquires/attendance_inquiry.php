				...
				//$sql = kv_hrm_get_employee_list();
					while ($row = db_fetch_assoc($selected_empl)) {
                                           ...
                                           //------------------------------------------------Manual Day Deduction ------------------------------------------------ 
                                               ...
                                               // $weekly_off_days = calculate_weekly_off(date("Y-m", strtotime($months_with_years_list[get_post('month')])).'01', $end_date);
                                            //---------------------------------------------------------------------------------------------------------------------
						...
						$week_end=1;
                                                $week_end2= 0;
                                              // [COMENTED TO MAKE SAT SUN WEEKLY OF BY ASHUTOSH 15-01-2019] echo $weekly_offdat."==".$week_end;
						$weekly_offdat = 5;//for staurday
                                                $weekly_offdat2 = 6;//for sunday
                                               // echo $weekly_offdate;
