...
include($path_to_root . "/modules/ExtendedHRM/includes/ui/common.inc" );
	...
	if ($input_error != 1)
	{
		update_company_prefs(
			get_post( array('coy_name','coy_no','gst_no','tax_prd','tax_last',
				'postal_address','country','state','phone', 'fax', 'email', 'coy_logo', 'domicile',
...
country_list_row(_("Country"), 'country', $_POST['country'], true, false);
state_list_row(_("State / Union Territories:"), 'state', $_POST['state'], $_POST['country'], false, false);
//text_row_ex(_("State:"), 'state', $_POST['state'], 34, 5);
